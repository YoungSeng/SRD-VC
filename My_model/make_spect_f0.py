...
# Modify as needed
rootDir = "/ceph/home/yangsc21/Python/autovc/My_model/assets/test_wav_16000_/"
targetDir_f0 = "/ceph/home/yangsc21/Python/autovc/My_model/assets/test_raptf0_/"
targetDir = "/ceph/home/yangsc21/Python/autovc/My_model/assets/test_spmel_/"
...
for subdir in sorted(subdirList):
    ...
    for fileName in sorted(fileList):
        ...
        try:
            ...
            print(os.path.join(dirName,subdir,fileName))
        assert fs == 16000
        if x.shape[0] % 256 == 0:
